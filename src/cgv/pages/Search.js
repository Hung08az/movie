...
const SearchPage = () => {
    ...
    useEffect(() => {
        setLoading(true); // bat dau call api
            console.log('keyword ');
            setLoading(true); // bat dau call api
            api.searchMoviesByName('thor', 1).then(response => {
                ...
                if(page === 1 && clickPage === false){
                        ...
                        if(response.hasOwnProperty('total_results')){
    ...
    return (
        ...
        >
            <Row>
                <Col span={12} offset={11} style={{marginBottom:"30px",fontSize:"24px",fontWeight:"500"}}>
                    Search For Movie
                </Col>
            </Row>
            <Row>
